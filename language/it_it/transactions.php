...
$lang['Transactions.!error.currency.length'] = "La valuta deve essere di 3 caratteri di lunghezza.";
...
$lang['Transactions.!error.transaction_id.exists'] = "ID di transazione non valido.";
$lang['Transactions.!error.date_added.format'] = "La data della transazione non può essere una data futura.";
$lang['Transactions.!error.invoice_id.exists'] = "Numero fattura non valido";
$lang['Transactions.!error.date.format'] = "La data applicata non è valida.";
$lang['Transactions.!error.name.empty'] = "Inserisci un nome.";
...
$lang['Transactions.status.declined'] = "Rifiutato";
$lang['Transactions.status.void'] = "Vuoto";
$lang['Transactions.status.error'] = "Errore";
$lang['Transactions.status.pending'] = "In attesa di";
$lang['Transactions.status.returned'] = "Restituito";
$lang['Transactions.!error.amounts.positive'] = "Uno o più valori Amount to Pay sono negativi. Assicurarsi che ogni importo da pagare sia zero o più.";
$lang['Transactions.status.refunded'] = "Rimborsato";
$lang['Transactions.!error.currency.missing'] = "Imposta una valuta.";
$lang['Transactions.!error.currency.mismatch'] = "La valuta specificata non corrisponde ad almeno una delle fatture associate.";
$lang['Transactions.!error.amounts.overage'] = "Impossibile applicare uno o più valori Importo da pagare alla fattura specificata. Assicurarsi che l'importo da pagare non superi l'importo dovuto sulla fattura, che la fattura sia aperta e che la somma dei valori dell'importo da pagare non superi l'importo del pagamento o del credito.";
...
$lang['Transactions.!error.type.valid'] = "Seleziona un tipo valido.";
$lang['Transactions.debit_types.debit'] = "Addebito";
$lang['Transactions.debit_types.credit'] = "Credito";
$lang['Transactions.!error.message.length'] = "

La lunghezza del messaggio non può superare i 255 caratteri.
";
$lang['Transactions.!error.transaction_id.length'] = "La lunghezza dell'ID transazione non può superare i 128 caratteri.";
$lang['Transactions.!error.parent_transaction_id.length'] = "La lunghezza dell'ID della transazione principale non può superare i 128 caratteri.";
